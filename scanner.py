...
# ---------------------------------------------------------------------
# PROJETO: ROBÔ OVER 0.5 HT (VERSÃO FINAL BLINDADA - CUSTO ZERO VITALÍCIO)
# ---------------------------------------------------------------------
TELEGRAM_TOKEN = "8977957095:AAFGcSuzjKxb2uX0lQzWwaozFdrreZ9myjc"
TELEGRAM_CHAT_ID = "@robo_over_05_ht"

# Servidor descentralizado de contingência (Não bloqueia IP e não exige chaves)
...
for loop in range(100):
    ...
    try:
        # Puxa o JSON bruto usando parâmetros aleatórios para enganar o cache do servidor
